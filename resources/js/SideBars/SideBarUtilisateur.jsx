...
const SidebarUtilisateur = ({ sidebarOpen, setSidebarOpen }) => {
  return (
    <aside
      className={`
    ...
    >
      ...
      <div>
        ...
        <Link
          href={route("utilisateur.historiques.index")}
          className="px-4 py-2 hover:bg-blue-700 flex items-center gap-3 cursor-pointer"
        >
...
export default SidebarUtilisateur;

...
export default function Filtresup({ onClose, onApply, initialFilters }) {
              ...
              {selectedFilters.categories.map((c) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="ml-1 text-white text-xs leading-none w-4 h-4 flex items-center justify-center rounded-full hover:bg-blue-600 transition"
                  >
                    ✕
                  </button>
                </span>
